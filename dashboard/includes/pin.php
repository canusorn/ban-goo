                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-3">
                                             <div class="form-group">
                                                 <label for="pin" data-toggle="tooltip" title="Pin ที่ต้องการใช้งาน ต้องเป็น pin ที่ไม่ได้งานกับเซนเซอร์อยู่แล้ว">Pin</label>
                                                 <select class="custom-select form-control-border border-width-2" name="pin" required>
                                                     <option>D0</option>
                                                     <option>D1</option>
                                                     <option>D2</option>
                                                     <option>D3</option>
