...
class Data_7_min
{
    ...
    {
        $commands = [
            'CREATE TABLE IF NOT EXISTS \'7_min\'(
                                        c0	REAL,
                                        c1	REAL,
                                        c2	REAL,
                                        c3	REAL,
            ...
            'CREATE INDEX IF NOT EXISTS time_index ON \'7_min\' (time);'
        ];
        //var_dump($commands);
    ...
    {
        $sql = "INSERT INTO '7_min' VALUES(:c0,:c1,:c2,:c3,:c4,:c5,:c6,:c7,:c8,:c9,:c10,:c11,:c12,:c13,:c14,:c15,:c16,:c17,:c18,:c19,:c20,:c21,:c22,:c23,:c24,:c25,:c26,:c27,:c28,:c29,:c30,:c31,:time)";
    ...
    public static function getLast($esp_id, $limit = 1, $columns = '*')
    {
        ...
        $sql = "SELECT $columns FROM '7_min' ORDER BY time DESC LIMIT {$limit}";
